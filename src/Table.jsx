...
// );
  ...
  return (
    <div>
      ...
      <button className='btn btn-danger my-2' onClick={naviagateToForm}>Navigate To Form</button>

        {/* Button and heading area */}
        <div class="d-flex justify-content-between ">
          <h5>Credentials <span className='opacity-50'>({credentials.length})</span> </h5>
          <Link to='/'> <button className="btn btn-coustom text-white d-flex mx-auto">
            <div className='mr-4'>
                ...
                <tr key={index}>
                  ...
                  <td>
                    <div className='d-flex'>
                      ...
                      <button className='btn btn-danger mx-md-2' onClick={() => handleDelete(index)}>
      ...
      <Modal show={showModal} onHide={handleClose}>
                ...
                <Modal.Body>
                    {/* Start form */}
                <form className="row g-3 mt-1" onSubmit={e => handleSave(e, editIndex)}>
                    ...
                    <div className="col-12 d-flex flex-row-reverse gap-4 mt-4">
                        <Button type="submit" variant=""  className="btn btn-success text-white px-4">Update</Button>
                        <Button variant="" className="btn btn-info text-light px-4" onClick={handleClose}>Close</Button>
                    </div>
                </form>
                </Modal.Body>
            </Modal>
